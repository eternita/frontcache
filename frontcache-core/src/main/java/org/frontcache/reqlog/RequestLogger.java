 ...
 *  
 *	log-timestamp request-id   is-hystrix-error{success|error}   request-type {toplevel|include}   is-cacheable{cacheable|direct}   is-cached{dynamic|from-cache}     runtime-millis    datalength-bytes   url   client-IP    frontcache-ID    client-type{bot|browser}    user-agent
 *  
 *  EXAMPLE
 ...
 *  2016-06-03T15:06:35,105-0600 1649b11f-8acf-4718-8e0b-abdcf7356212 success include cacheable from-cache 0 1411 "http://myfc.coinshome.net:8080/fc/external-ads.htm?locale=" 127.0.0.1 front-cache-local-1 browser
