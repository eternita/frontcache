...
(function(window) {
	...
	jQuery.get(getRelativePath("resources/hystrix/components/hystrixThreadPool/templates/hystrixThreadPool.html"), function(data) {
		htmlTemplate = data;
	});
	jQuery.get(getRelativePath("resources/hystrix/components/hystrixThreadPool/templates/hystrixThreadPoolContainer.html"), function(data) {
