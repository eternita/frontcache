...
(function(window) {
	...
	jQuery.get("resources/hystrix/components/hystrixThreadPool/templates/hystrixThreadPool.html", function(data) {
		htmlTemplate = data;
	});
	jQuery.get("resources/hystrix/components/hystrixThreadPool/templates/hystrixThreadPoolContainer.html", function(data) {
