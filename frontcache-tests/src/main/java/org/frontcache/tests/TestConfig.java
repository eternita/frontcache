...
public class TestConfig {
	...
	public static final String FRONTCACHE_STANDALONE_TEST_BASE_URI = "http://localhost:9080/";
	
	public static final String FRONTCACHE_FILTER_TEST_BASE_URI = "http://localhost:8080/";
