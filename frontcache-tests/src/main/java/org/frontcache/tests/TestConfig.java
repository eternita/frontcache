...
public class TestConfig {
	...
	public static final String FRONTCACHE_STANDALONE_TEST_BASE_URI_FC1 = "http://fc1.test.org:9080/";
	
	public static final String FRONTCACHE_FILTER_TEST_BASE_URI_FC1 = "http://fc1.test.org:8080/";

	public static final String FRONTCACHE_STANDALONE_TEST_BASE_URI_FC2 = "http://fc2.test.org:9080/";
	
	public static final String FRONTCACHE_FILTER_TEST_BASE_URI_FC2 = "http://fc2.test.org:8080/";
